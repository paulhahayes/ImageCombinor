...
use args::Args;
use image::{io::Reader,ImageFormat, DynamicImage, GenericImageView, imageops::FilterType::Triangle, ColorType::Rgba8, ImageError};
...
fn main() -> Result<(), ImageDataErrors> {
    ...
    if let Err(e) = image::save_buffer_with_format(output.name, &output.data , output.width, output.height, Rgba8, image_format_2) {
